...
pub fn projects_routes() -> Router<SharedState> {
    Router::new()
        ...
        .route(
            ...
            put(update_project_instructions),
        )
        .route(
            "/projects/{id}/members/search",
            get(search_users_for_project),
        )
        .route(
            "/projects/{id}/members",
        ...
        .route(
            "/projects/{id}/sources/{source_id}",
            delete(delete_project_source),
        )
        .route(
            "/projects/{id}/artifacts",
            get(list_project_artifacts).post(add_project_artifact),
        )
        .route(
