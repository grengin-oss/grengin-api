...
use crate::{auth::claims::Claims, handlers::{chat::{delete_chat_by_id, get_chat_by_id, get_chats, update_chat_by_id}, chat_stream::{cancel_chat_stream, handle_chat_stream}}, state::SharedState};
...
pub fn chat_routes() -> Router<SharedState> {
   Router::new()
    ...
    .route("/chat/stream/{message_id}/cancel", post(cancel_chat_stream))
