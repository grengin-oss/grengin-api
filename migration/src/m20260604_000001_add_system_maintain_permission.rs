    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        insert_permission
            ...
            .values_panic([
                ...
                "maintain".into(),
                false.into(),
                "permissions.system.maintain.description".into(),
        ...
        let permission_ids = self
            .lookup_permission_ids(manager, "system", &["maintain"])
            .await?;
        ...
        manager
            .exec_stmt(
                Query::delete()
                    ...
                    .and_where(Expr::col(Permissions::Domain).eq("system"))
                    .and_where(Expr::col(Permissions::Action).eq("maintain"))
                    .to_owned(),
            )
            .await?;
