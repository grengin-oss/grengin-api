...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        if manager
            .has_column("conversation_summaries", "conversation_id")
            .await?
            && !manager
                .has_column("conversation_summaries", "conversationId")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("conversation_summaries", "last_message_id")
            .await?
            && !manager
                .has_column("conversation_summaries", "lastMessageId")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("conversation_summaries", "last_message_at")
            .await?
            && !manager
                .has_column("conversation_summaries", "lastMessageAt")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("conversation_summaries", "created_at")
            .await?
            && !manager
                .has_column("conversation_summaries", "createdAt")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("conversation_summaries", "updated_at")
            .await?
            && !manager
                .has_column("conversation_summaries", "updatedAt")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("message_embeddings", "message_id")
            .await?
            && !manager
                .has_column("message_embeddings", "messageId")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("message_embeddings", "conversation_id")
            .await?
            && !manager
                .has_column("message_embeddings", "conversationId")
                .await?
        {
            manager
                .alter_table(
        ...
        if manager
            .has_column("message_embeddings", "created_at")
            .await?
            && !manager
                .has_column("message_embeddings", "createdAt")
                .await?
        {
            manager
                .alter_table(
